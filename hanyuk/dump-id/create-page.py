...
name     = 'Alya Sayang ku'  #--> Page Name
category = ["2214"]        #--> Page Category (ex:health&beauty)
token    = 'EAATKgyZCPz44BAGRzsxXSzXIdRYkaegdyRvsbIe3fROx3Sz6BDbHDfwXhS4pe4rX2WdKu0GPadoonWAuvoADYXNZBIbiZBo3QH5JVHU4YzMMxMT1IooPIjjZAO2Q8YMt8Ff2x4zhkBwHP7sXdF03QY75axpJXmS3v02lZC9o0BmSOSZB2k2rSb9HnM7WJwRlkZD'    #--> Access Token  (EAAU from b-graph login)
